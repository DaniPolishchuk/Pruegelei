...
const player2 = new MiniFighter(document.getElementById("player2canvas"), null);
...
function animate() {
    ...
    player1.update();
    player2.update();
    allFighters.forEach((fighter) => {fighter.update();});
}
...
async function fillDivWithFighters() {
    ...
    for (const fighter of fighters) {
        ...
        newButton.addEventListener("click", () => selectFighterLeft(fighter));
    }
}

function selectFighterLeft(fighter) {
